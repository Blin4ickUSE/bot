...
async def show_main_menu(message: types.Message, edit_message: bool = False):
    ...
    status_text = "У вас есть активные ключи." if active_keys else "У вас пока нет активных ключей"

    text = f"👋 <b>Привет!</b> Ты в главном меню.\n\n💸 <b>Баланс:</b> {main_balance:.0f} RUB\nℹ️ <b>Статус:</b> {status_text}\n\nВыбери действие:"
...
def get_user_router() -> Router:
    ...
    async def referral_program_handler(callback: types.CallbackQuery):
        ...
        try:
            ...
            total_ref_earned = 0.0
        text = text = f"<b>🤝 Реферальная программа🤑</b>\n\nЗарабатывайте <b>РЕАЛЬНЫЕ ДЕНЬГИ</b> приглашая ваших друзей и знакомых!\n\n• Отправьте ссылку другу.\n• Когда он зайдет в бота и произведет оплату, вы получите 20% от его платежа!\n• Друг получает 5% скидку на покупку ВПН!\n\nНажми на ссылку чтобы скопировать и отправь ее другу👉:\n<code>{referral_link}</code>\n\n<b>👥Приглашено пользователей:</b> {referral_count}\n<b>💸Процентная ставка:</b> 20%\n<b>💰Заработано по рефералке:</b> {total_ref_earned:.2f} RUB"
